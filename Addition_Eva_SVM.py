...
if __name__ == "__main__":
    ...
    X_add, y_add = X_train[100:100 + Add_Size, :], y_train[100:100+Add_Size]
    ...
    fig_spam.savefig(save_path + '/Loss_compare_add_C1_SVM.png', bbox_inches = 'tight')
    fig_spam.show()

    para_dist= para_comp_add_fig(para_true, para_kkt,para_inf, subset_size,config['dataset_name'],
                                 mod_config['base_model'], Data_size, Add_Size)
    para_dist.savefig(save_path + '/para_dist_add_inf_C1_SVM.png', bbox_inches = 'tight')
    para_dist.show()
    ...
    fig_higgs.savefig(save_path + '/Loss_compare_add_C1_SVM.png', bbox_inches = 'tight')
    fig_higgs.show()
