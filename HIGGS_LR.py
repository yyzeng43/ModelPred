...
if __name__ == "__main__":
    ...
    if PERMSET == 'Perm':
        LR_data.permutation_generation(X_train, y_train, Perm_NUM)
    elif PERMSET == 'RAND':
    ...
    train_loss, valid_loss = Util_deep_mod.fit(X_train, y_train, train_set,
                                               valid_set, 1 / config['lambda'], n_epoch, kkt_lambda=1)
    model_savename = result_path + '/HIGGS_LR_{}_{}_Del0_KKT_Utl_{}_L1L2_{}_{}_C_{}.state_dict'.\
    ...
    model_savename = result_path + \
                     '/HIGGS_LR_Perm_regressor_Extr_Del0_Utl_15_NepochFalse_L1L2_128_128_C_1.0.state_dict'
    sys.stdout.flush()
    torch.save(Util_deep_mod.model.state_dict(), model_savename)
