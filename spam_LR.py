...
if __name__ == "__main__":
    ...
    model_savename = result_path + '/spam_LR_{}_{}_Del0_KKT_Utl_{}_L1L2_{}_{}_C_{}.state_dict'.\
    ...
    model_savename = result_path + \
                     '/spam_LR_Perm_regressor_Extr_Del0_Utl_15_NepochFalse_L1L2_128_128_C_1.0.state_dict'
    sys.stdout.flush()
    torch.save(Util_deep_mod.model.state_dict(), model_savename)
